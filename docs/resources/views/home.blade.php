        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <h1 class="display-4 text-uppercase text-primary mb-2" style="-webkit-text-stroke: 2px #ffffff;">Chandani Bhattarai</h1>
                    <h1 class="typed-text-output d-inline font-weight-lighter text-white"></h1>
                    <div class="typed-text d-none">Software Developer</div> <!-- Keeping it hidden if not needed -->                    
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                        <a href="{{ asset("storage/CV..pdf") }}" class="btn btn-outline-light mr-5">Download CV</a>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    {{-- <a href="{{ asset("storage/CV..pdf") }}" class="btn btn-outline-primary mr-4">Hire Me</a> --}}
...
@endif
    ...
    <div class="container-fluid bg-primary text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="container text-center py-5">
            ...
            <p class="m-0">&copy; <a class="text-white font-weight-bold" href="#">2024@</a>All Rights Reserved.
                <a class="text-white font-weight-bold">Created by Chandani Bhattarai</a> &#10084;
            </p>            
        </div>
    </div>
    <!-- Footer End -->
